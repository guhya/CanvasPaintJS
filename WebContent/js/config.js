var ewPaint = angular.module('ewPaint', []);

ewPaint.config(function($interpolateProvider) {
  $interpolateProvider
    .startSymbol('{[')
    .endSymbol(']}');
});

ewPaint.directive('bindValueTo', function() {
  return {
    restrict: 'A',
...
ewPaint.directive('objectButtonsEnabled', function() {
  return {
    restrict: 'A',
