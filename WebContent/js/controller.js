...
function addAccessors($scope) {
  ...
  $scope.addLine = function() {
    ...
    var o = new fabric.Line([ 50, 100, 200, 200], {
      left: coord.left,
      top: coord.top,
  ...
  $scope.addShape = function(url) {
    //console.log('adding shape', url);
    //var coord = getRandomLeftTop();
    var coord = {left:150, top:150};
  ...
  $scope.addImage = function(url, minScale, maxScale) {
    //var coord = getRandomLeftTop();
  ...
  $scope.rasterize = function() {
    if (!fabric.Canvas.supports('toDataURL')) {
      ...
      document.getElementById("exportedImage").src = canvas.toDataURL('image/png');
    }
  };
  ...
  var pattern = new fabric.Pattern({
    source: '/canvaspaint/img/escheresque.png',
    repeat: 'repeat'
  });
...
ewPaint.controller('EwideController', function($scope) {
  $scope.canvas = canvas;
